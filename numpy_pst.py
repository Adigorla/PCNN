...
def cart2pol(x, y):
     ...
     rho = np.hypot(x, y)
     return (theta, rho)    
def ground_PST(I,LPF,Phase_strength,Warp_strength, Threshold_min, Threshold_max, Morph_flag):
     L=0.5
     print('{},{}'.format(I.shape[0],I.shape[1]))
     ...
     #print('Ground truth: {}'.format(Image_orig_f))
